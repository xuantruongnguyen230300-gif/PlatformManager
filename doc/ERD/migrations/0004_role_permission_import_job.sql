...
-- src/BE/Core/PlatformManager.Core.Infrastructure/Persistence/Migrations/sql/0004_role_permission_import_job.sql
--
-- Nội dung:
...
-- phải seed tay tương đương — xem mục "Rủi ro rollout" ở doc/contracts/permissions.md.
--

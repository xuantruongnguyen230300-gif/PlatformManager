...
| 🧊 `doc/Prototype/` | **ĐÓNG BĂNG — TUYỆT ĐỐI không trích token từ đây.** Giá trị đã lệch thật: `bg` `#f3f6fb`→`#eef2f8`, `text-muted` `#6d788b`→`#57647a`, `success` `#14855b`→`#0e7050`, `container-max-width` 1450→1600px, và app có nhiều token prototype không hề có. |
